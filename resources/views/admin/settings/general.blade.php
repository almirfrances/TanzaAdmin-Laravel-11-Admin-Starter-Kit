                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="site_email" name="site_email" value="{{ old('site_email', $settings['site_email'] ?? '') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="site_phone" name="site_phone" value="{{ old('site_phone', $settings['site_phone'] ?? '') }}" required>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="telegram_url" name="telegram_url" value="{{ old('telegram_url', $settings['telegram_url'] ?? '') }}">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="color" class="form-control" id="primary_color" name="primary_color" value="{{ old('primary_color', $settings['primary_color'] ?? '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="footer_copyright" name="footer_copyright">{{ old('footer_copyright', $settings['footer_copyright'] ?? '') }}</textarea>
