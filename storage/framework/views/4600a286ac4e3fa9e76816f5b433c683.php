    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('user.settings.account')); ?>"><i class="ti-xs ti ti-users me-1"></i> Account</a>
                </li>
                <?php endif; ?>

                <?php if (\Illuminate\Support\Facades\Blade::check('isVendor')): ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('vendor.settings.account')); ?>"><i class="ti-xs ti ti-users me-1"></i> Account</a>
                </li>
                <?php endif; ?>

                <?php if (\Illuminate\Support\Facades\Blade::check('isUniversity')): ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('university.settings.account')); ?>"><i class="ti-xs ti ti-users me-1"></i> Account</a>
                </li>
                <?php endif; ?>
                <li class="nav-item">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?php if (\Illuminate\Support\Facades\Blade::check('isUser')): ?>
                    <form action="<?php echo e(route('user.settings.updatePassword')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('isVendor')): ?>
                    <form action="<?php echo e(route('vendor.settings.updatePassword')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="mb-3 col-md-6 form-password-toggle">
                                <label class="form-label" for="currentPassword">Current Password</label>
                    ...
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('isUniversity')): ?>
                    <form action="<?php echo e(route('university.settings.updatePassword')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="mb-3 col-md-6 form-password-toggle">
                                <label class="form-label" for="currentPassword">Current Password</label>
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/almir/Desktop/tanzaadmin/resources/views/user/settings/security.blade.php ENDPATH**/ ?>