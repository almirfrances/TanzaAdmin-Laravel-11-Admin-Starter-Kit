        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        <img src="<?php echo e(asset('storage/' . ($settings['logo_light'] ?? 'path/to/default/logo_light.png'))); ?>" alt="Light Logo" class="img-fluid mb-3" style="background-color: black;">
            ...
            <div class="col-md-6">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        <img src="<?php echo e(asset('storage/' . ($settings['logo_dark'] ?? 'path/to/default/logo_dark.png'))); ?>" alt="Dark Logo" class="img-fluid mb-3">
            ...
            <div class="col-md-6">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        <img src="<?php echo e(asset('storage/' . ($settings['favicon'] ?? 'path/to/default/favicon.png'))); ?>" alt="Favicon" class="img-fluid mb-3" style="width: 50px; height: 50px;">
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/almir/Desktop/tanzaadmin/resources/views/admin/settings/logo.blade.php ENDPATH**/ ?>