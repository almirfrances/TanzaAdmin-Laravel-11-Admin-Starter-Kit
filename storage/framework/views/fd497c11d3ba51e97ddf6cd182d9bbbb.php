...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="mb-4"><?php echo e($title); ?></h4>
    <p class="mb-4">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.settings.email.update')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 mb-3">
                                        ...
                                        <select id="email_method" name="email_method" class="form-select">
                                            <option value="phpmailer" <?php echo e(old('email_method', $settings['email_method'] ?? 'phpmailer') == 'phpmailer' ? 'selected' : ''); ?>>Default PHP Mailer</option>
                                            <option value="smtp" <?php echo e(old('email_method', $settings['email_method'] ?? '') == 'smtp' ? 'selected' : ''); ?>>SMTP</option>
                                        </select>
                                ...
                                <div id="smtp-settings" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-3">
                                            ...
                                            <input type="text" id="smtp_host" name="smtp_host" class="form-control" placeholder="e.g., smtp.example.com" value="<?php echo e(old('smtp_host', $settings['smtp_host'] ?? '')); ?>">
                                            <small class="text-muted">The address of your SMTP server (e.g., smtp.gmail.com).</small>
                                        </div>

                                        <div class="col-md-6 col-12 mb-3">
                                            <label for="smtp_port" class="form-label">SMTP Port</label>
                                            <input type="number" id="smtp_port" name="smtp_port" class="form-control" placeholder="e.g., 587" value="<?php echo e(old('smtp_port', $settings['smtp_port'] ?? '')); ?>">
                                            <small class="text-muted">The port your SMTP server uses (e.g., 587 for TLS, 465 for SSL).</small>
                                        </div>

                                        <div class="col-md-6 col-12 mb-3">
                                            <label for="smtp_username" class="form-label">SMTP Username</label>
                                            <input type="text" id="smtp_username" name="smtp_username" class="form-control" placeholder="e.g., your-email@example.com" value="<?php echo e(old('smtp_username', $settings['smtp_username'] ?? '')); ?>">
                                            <small class="text-muted">Your SMTP account's username (usually your email address).</small>
                                        </div>

                                        <div class="col-md-6 col-12 mb-3">
                                            <label for="smtp_password" class="form-label">SMTP Password</label>
                                            <input type="password" id="smtp_password" name="smtp_password" class="form-control" placeholder="••••••••" value="<?php echo e(old('smtp_password', $settings['smtp_password'] ?? '')); ?>">
                                        ...
                                        <div class="col-md-12 col-12 mb-3">
                                            ...
                                            <select id="smtp_encryption" name="smtp_encryption" class="form-select">
                                                <option value="none" <?php echo e(old('smtp_encryption', $settings['smtp_encryption'] ?? 'none') == 'none' ? 'selected' : ''); ?>>None</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <input type="email" id="smtp_from_email" name="smtp_from_email" class="form-control" placeholder="e.g., no-reply@example.com" value="<?php echo e(old('smtp_from_email', $settings['smtp_from_email'] ?? '')); ?>">
                                        <small class="text-muted">The email address that will appear as the sender of the emails.</small>
                                    </div>

                                    <div class="col-md-6 col-12 mb-3">
                                        <label for="smtp_from_name" class="form-label">From Name</label>
                                        <input type="text" id="smtp_from_name" name="smtp_from_name" class="form-control" placeholder="e.g., Your Company Name" value="<?php echo e(old('smtp_from_name', $settings['smtp_from_name'] ?? '')); ?>">
                ...
                <div class="col-md-4 col-12">
                    <div class="card mb-4 shadow-sm">
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.settings.email.test')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/almir/Desktop/tanzaadmin/resources/views/admin/settings/email.blade.php ENDPATH**/ ?>