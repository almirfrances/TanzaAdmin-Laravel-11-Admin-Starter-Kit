            ...
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-4">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('isUser')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('user.settings.security')); ?>"><i
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('isVendor')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('vendor.settings.security')); ?>"><i
                                    class="ti-xs ti ti-lock me-1"></i> Security</a>
                        </li>
                    <?php endif; ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php if (\Illuminate\Support\Facades\Blade::check('isUser')): ?>
                            <form action="<?php echo e(route('user.settings.updateAccount')); ?>" method="POST"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img src="<?php echo e($user->profile_image ? asset('images/profile/' . $user->profile_image) : asset('assets/img/avatars/default.png')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address"
                                                value="<?php echo e(old('address', $user->address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="city" name="city"
                                                value="<?php echo e(old('city', $user->city)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="state" name="state"
                                                value="<?php echo e(old('state', $user->state)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="postal_code" name="postal_code"
                                                value="<?php echo e(old('postal_code', $user->postal_code)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('isVendor')): ?>
                            <form action="<?php echo e(route('vendor.settings.updateAccount')); ?>" method="POST"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img src="<?php echo e($user->profile_image ? asset('images/profile/' . $user->profile_image) : asset('assets/img/avatars/default.png')); ?>"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="vendor_name" name="vendor_name"
                                                value="<?php echo e(old('vendor_name', $user->vendor_name)); ?>" required>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (accountImageReset) {
                accountImageReset.addEventListener('click', function() {
                    uploadedAvatar.src =
                        '<?php echo e($user->profile_image ? asset('images/profile/' . $user->profile_image) : asset('assets/img/avatars/default.png')); ?>';
...
<?php echo $__env->make('user.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TUFF\Documents\Laravel\TanzaAdmin-Laravel-11-Admin-Starter-Kit\resources\views/user/settings/account.blade.php ENDPATH**/ ?>